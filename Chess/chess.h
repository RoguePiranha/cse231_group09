...
private:
	...
	int enPassantTarget = -1; // -1 means no target available
	...
	/***************************************************
	 * EN PASSANT
	 * Checks if the conditions for en passant have been met
	 ***************************************************/
	bool enPassant(char* board, int positionFrom, int positionTo, int enPassantTarget) {}
...
public:
	 ...
	 *********************************************/
	bool move(char *board, int positionFrom, int positionTo, int enPassanttarget, bool whiteCastle, bool blackCastle) {}
